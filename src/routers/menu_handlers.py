...
async def cb_menu_mood(callback: types.CallbackQuery):
    ...
    text = (
        ...
        "Обери — і Нетик підбере ідеальне кіно під твій стан."
    )
    keyboard = []
    row = []
...
async def cb_menu_help(callback: types.CallbackQuery):
    ...
    text = (
        ...
        "🧠 <b>За настроєм</b> — кіно під твій настрій\n"
        "🌿 <b>Мій список</b> — твій персональний список\n"
        "🃏 <b>Свайп-режим</b> — гортай як у Tinder\n"
        "🎯 <b>Вгадай рейтинг</b> — грай та збирай бали\n"
        "🧩 <b>Емодзі-кіно</b> — вгадуй фільм за картинками\n"
